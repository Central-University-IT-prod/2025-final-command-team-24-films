...
async def login(body: LogIn):
    ...
    if body.email not in ["friend@example.com","admin@example.com"]:
        ...
        new_token = "REDACTED.eyJlbWFpbCI6ImFkbWluQGV4YW1wbGUuY29tIiwiZXhwIjoxNzQxMDUwOTU1fQ.v-N50e06R55-dp__TcVLNNsqYCG2V7TIed7ZAkMWxKE"
    else:
        new_token = "REDACTED.eyJlbWFpbCI6ImZyaWVuZEBleGFtcGxlLmNvbSIsImV4cCI6MTc0MTA1MDk1NX0.UCfCQRK4F-sl6uX5S4sahhe7z0l499383K7Ra6NLyQg"
